...
'''
    ...
    await bot.send_message(chat_id="5438977917", text=txt)
    await state.clear()
...
async def start(bot: Bot):
    await bot.send_message(chat_id="5438977917", text="Bot Ishga tushdi ✅")


async def stop(bot: Bot):
    await bot.send_message(chat_id="5438977917", text="Bot To'xtadi ⚠️")
